        ...
        <main className="mx-[3em]">
          ...
          <section>
            ...
            <form className="flex flex-col items-center p-2 mt-[8em] xl:mt-[6em]">
              ...
              <br />
              <input type="text" id="email" className="ml-[9.6em] md:w-2/5 md:self-end xl:self-start xl:ml-[7.7em]"></input>
              <br />
              ...
              <br />
              <button className="bg-yellow-600 rounded px-2 md:px-12 md:text-2xl md:pb-1 xl:self-start">Submit</button>
            </form>
          </section>
        </main>
      </div>

      <div className="h-screen w-full flex flex-col  text-white bg-zinc-400 md:bg-orange-200 xl:bg-green-200 pt-4">
        <main className="mx-[3em]">
