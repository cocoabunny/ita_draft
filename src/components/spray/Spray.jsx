...
const Spray = () => {
    return (
        <div>
            {/* Spraying Page */}
            <div className="bg-spray-mobile xl:bg-spray-tablet bg-cover w-full min-w-[360px] min-h-screen ">
                <div className="flex flex-col">
                    ...
                    {/* Container */}
                    <div className="flex flex-col h-[100vh] sm:mt-[2em] ml-[2em] md:ml-[3em] xl:ml-[4em] md:mt-[3em] xl:mt-[4em]">
                         {/* Title 1*/}
                         <div className="flex justify-start w-14/5 mb-[1em] mt-[2em] sm:mt-[5em] md:mt-[6em] xl:mt-[6em]">
                            <h2 className="text-4xl md:text-5xl text-ITA sm:text-white font-semibold ">FINAL TOUCH</h2>
                        </div>
                        {/* Article 1*/}
                        ...
                        <div className="flex justify-start w-4/5 mb-[1em] mt-[2em] sm:mt-[5em] md:mt-[6em] xl:mt-[6em]">
                            <h2 className="text-4xl md:text-5xl text-ITA sm:text-white font-semibold ">SPRAYING SERVICES</h2>
                        </div>
                        {/* Article 2*/}
                        <div className="sm:mx-[5.1em] md:mx-[5.1em] md:mt-[1em] md:ml-[6.1em] p-[.2em] ">
