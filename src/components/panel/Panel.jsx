        ...
        <div>
            ...
            <div className="bg-panel-mobile xl:bg-panel-tablet bg-cover sm:text-xl w-full min-w-[360px] min-h-screen">
                <div className="flex flex-col">
                    ...
                    {/* Container */}
                    <div className="flex flex-col h-[80vh] mt-[3em] ml-[2em] md:ml-[3em] xl:ml-[4em] md:mt-[1em] xl:mt-[4em]">
                        {/* Section 1*/}
                        ...
                        {/* Paragraph 1*/}
                        <div className="md:self-center md:w-2/5 p-[.2em] mx-[4em] mt-[2em] md:px-[2em] md:ml-[18em] xl:ml-[33em] 2xl:mt-[4em]">
                        ...
                        {/* Paragraph 2*/}
                        <div className="md:self-center p-[.2em] mx-[4em] sm:mt-[2em] md:w-2/5 md:px-[2em] md:m-1 md:ml-[18em] lg:mt-16 xl:ml-[33em]">
